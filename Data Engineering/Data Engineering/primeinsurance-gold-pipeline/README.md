...
This folder defines all source code for the 'primeinsurance-gold-pipeline' pipeline:
...
* Take a look at the sample under "sample_users_primeinsurance_gold_pipeline.py" to get familiar with the syntax.
