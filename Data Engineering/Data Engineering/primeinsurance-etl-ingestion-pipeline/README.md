...
This folder defines all source code for the 'primeinsurance-etl-ingestion-pipeline' pipeline:
...
* Take a look at the sample under "sample_users_primeinsurance_etl_ingestion_pipeline.py" to get familiar with the syntax.
