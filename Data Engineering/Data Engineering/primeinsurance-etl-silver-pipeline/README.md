...
This folder defines all source code for the 'primeinsurance-etl-silver-pipeline' pipeline:
...
* Take a look at the sample under "sample_users_primeinsurance_etl_silver_pipeline.py" to get familiar with the syntax.
